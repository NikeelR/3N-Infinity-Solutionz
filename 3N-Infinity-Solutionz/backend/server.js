...
if (!require("fs").existsSync(FRONTEND_DIR)) {
  ...
  console.error("Run `python3 build_site.py` from the repo root before starting the server.");
  process.exit(1);
}
...
// Start a local server when run directly (Render, Railway, `npm start`).
// On Vercel, the platform imports this module as a serverless function instead.
